...
const uni = graduates.filter(function(search){
  return search.university.substring(0,3) === "Uni";
});
console.log(uni);
...
*/
//changed the function name to what it should be called(we are looking for small not large)
const smallPopulation = zooAnimals.filter((small) => {
